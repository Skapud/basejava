...
public class ResumeTestData {
    public Resume create(String uuid, String fullName) {
        ...
        resume.setContact(MAIL, "qwertyu@bk.ru");
        ...
        resume.setContact(HOME_PAGE, "www.leningradspb.ru");
//        //
        resume.setSection(OBJECTIVE, new TextSection("Lead non-worker"));
        resume.setSection(PERSONAL, new TextSection("Good guy"));
        resume.setSection(ACHIEVEMENT, new ListSection(List.of("Achievement11", "Achievement12", "Achievement13")));
